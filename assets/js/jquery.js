$(document).ready(function(){ 
  ...
  $(".btn1, .btn2").on({
    mouseenter: function(){
      $(".btn1, .btn2").css("background-color", "white");
      $(".btn1 a, .btn2 a").css("color", "gray");
    },
    mouseleave: function(){
      $(".btn1, .btn2").css("background-color", "transparent");
      $(".btn1 a, .btn2 a").css("color", "white");
      }
});
      $pantalla = $(window);
    $('.fondo-encabezado').each(function(){
        var $this = $(this);
